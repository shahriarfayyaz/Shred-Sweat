...
import com.example.shredsweat.databinding.ActivityExerciseBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun setupRestView() {
        ...
        try {
            val soundURI = Uri.parse(
                "android.resource://com.example.shredsweat/" + R.raw.rest_start_sound)
    ...
    private fun playBoop() {
        try {
            val soundURI = Uri.parse(
                "android.resource://com.example.shredsweat/" + R.raw.boop)
            player = MediaPlayer.create(applicationContext, soundURI)
            player?.isLooping = false
            player?.start()
        } catch (e: Exception) {
